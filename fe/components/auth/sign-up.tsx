                ...
                <div className=" text-center">
                    ...
                    <div className="grid grid-cols-2 gap-3 w-[448px] ">
                        <div className="flex flex-col items-start gap-1 mb-4">
                            <label htmlFor="First Name" className="mb-1 text-sm block font-semibold">First Name</label>
                            <input type="text"
                                placeholder="John..."
                        ...
                        <div className="flex flex-col items-start gap-1 mb-4">
                            <label htmlFor="Last Name" className="mb-1 text-sm block font-semibold">Last Name</label>
                            <input type="text"
                                placeholder="Doe..."
                                className="w-full rounded-[16px] border border-[#FFE9CC] px-4 py-2 "
                            />
                    ...
                    <div className="flex flex-col text-left">
                        <label htmlFor="Email" className="mt-2 font-semibold">Email Address</label>
                        <input type="email"
                    ...
                    <div className="flex flex-col text-left">
                        <label htmlFor="Phone" className="mt-8 font-semibold">Phone Number</label>
                        <input type="number"
                    ...
                    <div className="grid grid-cols-2 gap-2 w-[448px] h-[50px] mb-20 mt-6 font-semibold">
                        <button className="border-3 border-[#FFE9CC] flex flex-col items-center justify-center rounded-[16px]">
                            Google
                        </button>
                        <button className="border-3 border-[#FFE9CC] flex flex-col items-center justify-center rounded-[16px]">
                            Facebook
