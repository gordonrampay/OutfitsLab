      ...
      <div className="max-w-6xl mx-auto py-4 px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">        
            ...
            <div className="flex items-end gap-7">
              ...
              <div>
                ...
                <p className="opacity-90 font-medium mb-3 text-gray-600">
                  Owner: <span className="text-black font-bold">{owner?.display_name || 'Unknown'}</span> • Joined {shop.created_at}
                </p>
                ...
                <div className="flex items-center gap-3">                      
                  ...
                  <span>{shop.rating} (342 reviews)</span>
                  <span className="bg-[#e0b565] backdrop-blur-3xl text-[12px] px-2.5 py-0.5 rounded-full border border-gray-300 ml-1 text-white">✓ Verified Seller</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <button className="text-white bg-[#d19f42] px-5 py-2.5 rounded-xl font-bold flex items-center hover:bg-orange-50 hover:text-[#d19f42] border border-[#d19f42] transition-colors">
            <HomeOutlined className="pr-2"/> View Store
          </button>
        </div>
      </div>    
    </div>
