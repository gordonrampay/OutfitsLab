  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { label: "Total Sales", value: `${dashboardData.totalSales.toLocaleString()}₫`, icon: "💰" },
              { label: "Active Products", value: dashboardData.activeProducts, icon: "📦" },
              { label: "Total Orders", value: dashboardData.totalOrders, icon: "📋" },
              { label: "Avg Rating", value: `${dashboardData.avgRating}/5`, icon: "⭐" }
            ].map((stat, idx) => (
                  ...
                  return (
                    <tr key={order.id} className="hover:bg-orange-50/20 transition group">
                      ...
                      <td className="px-6 py-4">
                        ...
                        <div className="text-[13px] text-gray-400 mt-0.5">Quantiy: {order.quantity}</div>
                      </td>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl border border-orange-100 shadow-sm p-6">
            <h3 className="font-bold text-lg flex items-center gap-2 mb-6"><RiseOutlined /> Top Products</h3>
                ...
                <div key={prod.id} className="flex items-center justify-between p-3 hover:bg-orange-50/50 rounded-xl transition">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-gray-400 font-bold">{prod.Sales} sold</div>
                    </div>
                  </div>
          ...
          {/* RECENT REVIEWS */}
          <div className="bg-white rounded-2xl border border-orange-100 shadow-sm p-6">
              <h3 className="font-bold text-lg flex items-center gap-2 mb-6"><StarOutlined /> Recent Reviews</h3>
